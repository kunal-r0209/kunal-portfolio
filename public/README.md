...
The file `kunal_resume.pdf` is the official resume file.
...
Replacing this file with a new version is fine, but the **filename must remain exactly `kunal_resume.pdf`** to ensure the download link works correctly.
