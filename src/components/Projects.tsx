...
const projects = [
  {
    title: '10xCoders',
    tagline: 'AI-Guided Full-Stack Education Platform',
    description: 'Scalable e-learning web platform offering dynamic tech roadmaps, curated learning resources, and community-driven discussion forums, paired with an AI career guidance chatbot spanning multiple tech domains.',
    achievements: [
      'Dynamic, domain-specific learning roadmaps for multiple tech tracks',
      'Community forums for peer discussion and knowledge sharing',
      'AI-powered career guidance chatbot for personalized direction',
      'Full-stack architecture with Spring Boot REST APIs and React frontend',
      'Dual-database design combining PostgreSQL and MongoDB for structured and flexible data',
    ],
    tech: ['Spring Boot', 'React.js', 'JPA', 'PostgreSQL', 'MongoDB', 'Express js', 'Render'],
    liveUrl: 'https://10xcoders-lyart.vercel.app/',
    githubUrl: 'https://github.com/kunal-r0209/10xcoders',
    gradient: 'from-purple-500 to-cyan-500',
    impactMetric: { value: 100, label: 'Featured Project', prefix: '' },
    image: '/images/10xCoders.png'
  },
  {
    title: 'Fitflow',
    tagline: 'AI-Driven Virtual Fitness Assistant',
    description: 'Real-time virtual fitness assistant that uses computer vision and pose estimation to track form, count reps automatically, and adapt workout routines for a smarter, more engaging training experience.',
    achievements: [
      'Real-time pose estimation using TensorFlow.js and Mediapipe',
      'Automatic rep counting for hands-free workout tracking',
      'Adaptive workout routines driven by live performance data',
      'Computer vision pipeline built with OpenCV for accurate motion detection',
      'Performance tracking dashboard to enhance user experience',
    ],
    tech: ['MERN', 'OpenCV', 'GSAP', 'TensorFlow.js', 'Mediapipe', 'Python'],
    liveUrl: 'https://fitflow-nine-theta.vercel.app/',
    githubUrl: 'https://github.com/kunal-r0209/Fitflow',
    gradient: 'from-orange-500 to-red-500',
    impactMetric: { value: 89, label: 'Real-Time Tracking', prefix: '' },
    image: '/images/Fitflow.png'
  },
  {
    title: 'LuxeLane',
    tagline: 'Full-Stack E-commerce Shopping Platform',
    description: 'Full-stack e-commerce application delivering secure user authentication, product management, shopping cart functionality, and search — built for efficient data handling and smooth user interactions.',
    achievements: [
      'Secure user authentication and session management',
      'Complete product management system with CRUD operations',
      'Shopping cart and search functionality for seamless UX',
      'RESTful backend APIs built with Spring Boot and Express.js',
      'Responsive frontend components built with React.js',
    ],
    tech: ['Spring Boot', 'React.js', 'JPA', 'PostgreSQL', 'MongoDB', 'Express js', 'Render'],
    liveUrl: 'https://e-commerce-luxlane-shopping.onrender.com/',
    githubUrl: 'https://github.com/kunal-r0209/E-commerce-LuxLane-shopping',
    gradient: 'from-blue-500 to-cyan-500',
    impactMetric: { value: 93, label: 'Full-Stack Build', prefix: '' },
    image: '/images/Luxe.png'
  },
  {
    title: 'PolicyPilot AI',
    tagline: 'RAG-Powered Insurance Assistant',
    description: 'AI-powered insurance assistant leveraging Retrieval-Augmented Generation to deliver context-aware policy responses, backed by a scalable, deployment-ready FastAPI architecture.',
    achievements: [
      ...
      'Vector search powered by FAISS for fast, relevant retrieval',
      'Scalable FastAPI backend with REST APIs',
      'Docker-based deployment-ready architecture',
    ],
    tech: ['Python', 'FastAPI', 'LangChain', 'FAISS', 'Groq Llama 3'],
    liveUrl: null,
    githubUrl: 'https://github.com/kunal-r0209/policypilot-ai',
    gradient: 'from-cyan-500 to-teal-500',
    impactMetric: { value: 98, label: 'RAG Accuracy', prefix: '' },
    image: '/images/Policypilot.png'
  },
  {
    title: 'Education HubAI',
    tagline: 'Inclusive Learning Platform for Accessibility',
    description: 'AI-driven inclusive learning platform designed for students with visual, hearing, and speech impairments, combining sign language recognition, text-to-speech, and multilingual accessibility to deliver scalable, real-time content.',
    achievements: [
      'Sign language recognition for hearing and speech-impaired students',
      'Text-to-speech (TTS) integration for visually impaired learners',
      'Multilingual accessibility features for wider reach',
      'GCP API integration (Gemini, TTS) for intelligent content delivery',
      'Agile-based sprint cycles ensuring scalable, real-time delivery',
    ],
    tech: ['React.js', 'Express.js', 'MongoDB', 'GCP APIs'],
    liveUrl: null,
    githubUrl: 'https://github.com/kunal-r0209/EducationHub.ai',
    gradient: 'from-teal-500 to-emerald-500',
    impactMetric: { value: 100, label: 'Accessibility Focus', prefix: '' },
    image: '/images/EducationHubAI.png'
  },
];
          ...
          >
            ...
            >
              <div className="text-center p-8 bg-white/5 rounded-3xl border border-white/10 hover:border-cyan-400/30 transition-colors">
                ...
                <a
                  href="https://github.com/kunal-r0209"
                  target="_blank"
                  rel="noopener noreferrer"
