...
const contactMethods = [
  {
    icon: Mail,
    label: 'Email',
    value: 'kl07kunal@gmail.com',
    href: 'mailto:kl07kunal@gmail.com',
    color: 'from-blue-500 to-cyan-500',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/kunal-suresh0209',
    href: 'https://www.linkedin.com/in/kunal-suresh0209',
    color: 'from-cyan-500 to-teal-500',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/kunal-r0209',
  ...
  },
  {
    icon: Instagram,
    label: 'Instagram',
    value: '@universaldesign029',
    href: 'https://www.instagram.com/universaldesign029?igsh=ZGl3YQ2dG1qMzEx',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 mt-4 text-lg">
            Open to opportunities in Full Stack Developering, Machine Learning, and Data Science
          </p>
        </motion.div>
        ...
        >
          <p>© 2026 S. Kunal. Crafted with passion and code.</p>
